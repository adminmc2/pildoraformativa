...
export function SlideOpening({
  ...
  return (
    <div className="relative w-full h-full max-w-[1800px] mx-auto flex flex-col items-center justify-center text-center px-4 md:px-8 overflow-x-hidden overflow-y-auto">
      ...
      <div className="relative mt-[3vh] flex flex-wrap items-end justify-center gap-[clamp(12px,2vw,32px)]">
        {cast.map((c) => {
          const Comp = c.Comp;
          return (
            <div
      ...
      <button
        onClick={onStart}
        className="relative mt-[3vh] px-10 py-3.5 md:px-16 md:py-5 rounded-full bg-[var(--color-pf-ink)] text-white font-[family-name:var(--font-pf-display)] hover:opacity-90 hover:scale-[1.02] transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--color-pf-spark)] focus-visible:ring-offset-2"
        style={{
